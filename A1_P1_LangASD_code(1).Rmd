...
```{r}
setwd("C:/Users/Karolina/Desktop/AU/Experimental Methods III/Assignments/ExpM3-Assignment1")
...
```{r}
library(reshape)
demo = rename(demo, c(Child.ID="SUBJ"))
...
```{r}
library(stringr)
LU$VISIT = str_extract(LU$VISIT,"\\d") # d means digit
